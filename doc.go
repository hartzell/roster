...
// avoid trailing commas when generating JSON,
// e.g. http://stackoverflow.com/questions/21305865/golang-separating-items-with-comma-in-template
//
...
//        inventory           (s) Generate an Ansible dynamic inventory
//
